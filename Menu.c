...
void atualizarAluno(struct Aluno *alunos, int numAlunos) {
    ...
    for (int contador = 0; contador < numAlunos; contador++) {
        if (alunos[contador].matricula == matricula) {
            ...
            // Verifica se os campos de nome e email nÃ£o excedem os limites maximos
    ...
    printf("Aluno com a matricula %d nÃ£o encontrado.\n", matricula);
}
        ...
        switch (menualuno) {
            ...
            case 5:
                break;
                    ...
                    default:
                        printf("Opcao invalida. Digite uma Opcao vÃ¡lida.\n");
                        }
                    } while (menualuno != 5);}

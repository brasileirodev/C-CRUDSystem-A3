...
=======
//@Hï¾‰CTOR VALENTE (22/11/2023) - Menu e implementaéˆ¬o da usabilidade inscriéˆ¬o de disciplina.
//@LUCAS (23/11/2023) - Menu e implementaéˆ¬o da usabilidade cadastro de aluno.
//@Hï¾‰CTOR VALENTE (23/11/2023) - Correéˆ¬o caracter especial.
>>>>>>> 0a3a6f3aa54693827da325172eecd659500072a1
...
void atualizarAluno(struct Aluno *alunos, int numAlunos) {
    ...
    for (int contador = 0; contador < numAlunos; contador++) {
        if (alunos[contador].matricula == matricula) {
            ...
            // Verifica se os campos de nome e email nï¾ƒï½£o excedem os limites maximos
    ...
    printf("Aluno com a matricula %d nï¾ƒï½£o encontrado.\n", matricula);
}
        ...
        switch (menualuno) {
            ...
            case 5:
                break;
                    ...
                    default:
                        printf("Opcao invalida. Digite uma Opcao vï¾ƒï½¡lida.\n");
                        }
                    } while (menualuno != 5);}
...
=======
//METODO TELA DO MENU SECUNDï¾ƒæŠ’IO - Padronizaï¾ƒï½§ï¾ƒï½£o de menu. Recebe um CHAR com o nome do menu selecionado
>>>>>>> 0a3a6f3aa54693827da325172eecd659500072a1
...
=======
    ...
    controle = strlen(texto); //FUNï¾ƒï¿½ã‚° QUE CONTA CARACTERE
>>>>>>> 0a3a6f3aa54693827da325172eecd659500072a1
...
int decisao(char texto[200]){
    ...
    while (decisao != 1 && decisao != 2) {
        system("clear");
        printf("Digito invalido, por favor digite (1 - SIM|2 - Nï¾ƒã‚°): \n"); 
        scanf("%s", &decisao);
    }
    return decisao;
    system("clear");
...
=======
        } while(menu != 0);  // Continua enquanto o usuario nï¾ƒï½£o escolher sair
>>>>>>> 0a3a6f3aa54693827da325172eecd659500072a1
	...
	//SAIR DO PROGRAMA
	//system("clear");
	//decisao("ALERTA! Voce irï¾ƒï½¡ sair do programa, deseja realmente sair?");
